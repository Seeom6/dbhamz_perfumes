...
export const customer = [
  {
    profile: profileImg,
    comment:
      "العطور ما شاء الله تبارك الله",
    name: " عنود القحطاني",
  },
  {
    profile: profileImg,
    comment:
      "الله يزاكم خير ما قصرتم الحمدلله وصلت الشحنه و كل شي تمام ",
    name: " ام محمد  ",
  },
  {
    profile: profileImg,
    comment:  " اصدق من تعاملت معهم مشكورين و فالواتساب احترام و تسامح جزاكم الله خير وانشالله لنا تعاملات ثانيه",
    name: " فيصل البارقي",
  },
  {
    profile: profileImg,
    comment:
      "العطور روووعة ما كنت متوقعة اخذ عطور بذا السعر و افضل عطر لويس فيتون ستلر تايمز الي خذيته عبر الواتس مررررة حلو",
    name: " مها العتيبي ",
  },
];
